...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # Contar lanzamientos exitosos por sitio
        success_counts = spacex_df[spacex_df['class'] == 1].groupby('Launch Site').size().reset_index()
        success_counts.columns = ['Launch Site', 'Counts']  # 🔹 FIX: Renombrar columnas correctamente
